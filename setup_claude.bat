...
echo.
echo [1/5] Git Hook (commit message format check)...
...
echo.
echo [2/5] .claude/settings.local.json...
...
echo.
echo [3/5] Migrate hooks (local -^> shared settings.json)...
...
echo.
echo [5/5] .gitignore (sprint / workspace entries)...
